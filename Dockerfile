...
RUN apt-get update && DEBIAN_FRONTEND=noninteractive apt-get -y install openssh-server pwgen && \
    ...
    apt-get install -y apache2 libapache2-mod-php5 php5-redis pwgen php-apc php5-mcrypt php5-gd php5-curl php5-mysql && \
...
#mongodb redis mysql
#RUN apt-get install -y mongodb redis-server mysql-server 
...
EXPOSE 22 80 6379 443 21 23 8080 8888 8000 27017 3306 9200 9300 5901
